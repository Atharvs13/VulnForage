...
CREATE TABLE IF NOT EXISTS lab_supply_chain (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS lab_crypto_keys (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  key_name TEXT NOT NULL,
  hash_md5 TEXT NOT NULL,
  plain_secret TEXT NOT NULL
);
CREATE TABLE IF NOT EXISTS lab_security_logs (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  raw_log TEXT NOT NULL,
  source_ip TEXT NOT NULL,
  created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP
);
CREATE TABLE IF NOT EXISTS lab_exception_states (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
